export default {
    ...
    /**
     * Generates a RFC4122 version 4 compliant uuid (with extremely small probability of collision)
     * Uniqueness relies heavily on the underlying random number generator
     */
    uuidv4() {
